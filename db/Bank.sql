...
INSERT INTO `Currencies` VALUES ('2cbb794f-64be-40e6-8b59-f2adea1ae002','USD','1'),('4223369d-048e-41ea-b2b7-3d479eb45ea9','EUR','1.06'),('acbcf47f-480d-4a74-906a-affcb891dfb8','CNY','0.14');
...
CREATE TABLE `CustomerInfo` (
  ...
  UNIQUE KEY `CustomerInfo_pk` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `CustomerInfo` VALUES ('0594c7cf-c099-47ce-9f06-463d51d94a62','test3','test3'),('43648221-c3c7-4993-a2ef-76e689fa6638','test1','test1'),('e8723158-6569-4606-8c2e-6c482efa6417','test2','test2');
...
INSERT INTO `DepositAccounts` VALUES ('43648221-c3c7-4993-a2ef-76e689fa6638','2cbb794f-64be-40e6-8b59-f2adea1ae002','8a5c826f-e313-484c-93fb-aa75efea26da',34,33333333,'checking'),('e8723158-6569-4606-8c2e-6c482efa6417','2cbb794f-64be-40e6-8b59-f2adea1ae002','a1516cc4-cc43-44c0-9030-6f9eb491ad2b',200,22222222,'saving'),('43648221-c3c7-4993-a2ef-76e689fa6638','2cbb794f-64be-40e6-8b59-f2adea1ae002','a2fb61ff-6d9d-459c-9b07-182c431d306d',133,88888,'checking');
...
CREATE TABLE `ManagerInfo` (
  ...
  PRIMARY KEY (`userID`),
  UNIQUE KEY `userID_UNIQUE` (`userID`),
  UNIQUE KEY `ManagerInfo_pk` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `SecurityAccounts` VALUES ('43648221-c3c7-4993-a2ef-76e689fa6638','32fbf25d-411f-4315-8ded-58f60459329b',2000,55555555);
...
INSERT INTO `Transactions` VALUES ('1','2','3',100,5,'2022-12-13 18:05:45','6','7'),('ea00bd20-44e4-4dbf-be1e-1ae028a87b31','8a5c826f-e313-484c-93fb-aa75efea26da','a2fb61ff-6d9d-459c-9b07-182c431d306d',10,10,'2022-12-14 23:04:34','888','999');
...
-- Dump completed on 2022-12-14 19:33:47
